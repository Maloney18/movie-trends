  ...
  return (
    <Stack as='section' pt={{base: '', md:'5'}} p={{base: '1', md:''}} pr={{base: '', md:'2'}} gap='7' pb='7'>
      ...
      <Stack gap={{base: '7', lg:'16'}}>
        <Collection isLoading={isLoading} isError={isError} data={data} error={error} title="Featured Movies" url="/movies"/>
        <Collection isLoading={loading} isError={errorState} data={result} error={err} title="Top Rated Movies" url="/movies"/>
        <Collection isLoading={seriesLoader} isError={seriesErrState} data={series} error={seriesErr} title="TV Series" url="/series"/>
      </Stack>
    </Stack>
  )
}
